...
I handled this project in which i learnt about details, advantages,
and disadvantages of using trees as data structures.Was also able to learn about how to
qualify trees as well as how to traverse them. In this project, I
implemented binary search, AVL, binary and Max Binary Heap trees.
...
## Authors
<details>
    <summary>Olawumi Damilola</summary>
    <ul>
    <li><a href="https://www.github.com/Deami2023">Github</a></li>
    <li><a href="https://www.twitter.com/Mzdeami">Twitter</a></li>
    <li><a href="mailto:glam4damsel@yahoo.com">e-mail</a></li>
    </ul>
